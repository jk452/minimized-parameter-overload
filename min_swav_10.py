...
CIFAR10_test.transform = transform_test
train_dataloader = DataLoader(CIFAR10_full, batch_size=BATCHSIZE, shuffle=True)
#val_dataloader = DataLoader(CIFAR100_val, batch_size=BATCHSIZE, shuffle=False)
val_dataloader = DataLoader(CIFAR10_test, batch_size=BATCHSIZE, shuffle=False)
